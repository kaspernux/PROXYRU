...
mysqli_multi_query($sql, "CREATE TABLE IF NOT EXISTS `payment_setting` (
    `rubpay_token` varchar(200) COLLATE utf8mb4_bin DEFAULT 'none',
    ...
    `RubPay` varchar(15) COLLATE utf8mb4_bin DEFAULT 'inactive',
...
if ($sql->query("SELECT * FROM `payment_setting`")->num_rows == 0) $sql->query("INSERT INTO `payment_setting` (`rubpay_token`, `nowpayment_token`) VALUES ('none', 'none')");
